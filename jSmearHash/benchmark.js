...
b.suite(
    'jSmearHash vs blurhash.decode 32x32',
...
b.suite(
    'jSmearHash vs blurhash.decode 64x64',
    b.add('blurhash.decode', () => {
        const blurHash = randomBlurHash();
        return () => blurhash.decode(blurHash, 64, 64);
    }),
    b.add('jSmearHash 32x32', () => {
        const blurHash = randomBlurHash();
...
b.suite(
    'jSmearHash vs blurhash.decode 100x50',
    b.add('blurhash.decode', () => {
        const blurHash = randomBlurHash();
...
b.suite(
    'jSmearHash vs blurhash.decode 640x480',
    b.add('blurhash.decode', () => {
        const blurHash = randomBlurHash();
